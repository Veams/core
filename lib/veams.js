...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultsHelper = __webpack_require__(10);
	var isTouchHelper = __webpack_require__(14);
	var mediaQueryHandler = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultsHelper = __webpack_require__(10);
	var queryHelper = __webpack_require__(11);
	var forEachHelper = __webpack_require__(12);
	var checkElInContextHelper = __webpack_require__(13);
	...
	var Modules = function () {
	   ...
	   */
				...
				var observer = new MutationObserver(function (mutations) {
					mutations.forEach(function (mutation) {
						...
						if (entry.el instanceof HTMLElement) {
							_this2.modulesInContext = queryHelper(_this2.queryString, entry.el);
							_this2.initInNewContext();
							console.log('modules: ', _this2.modulesInContext);
						}
					});
				});
			...
			key: 'initInNewContext',
			value: function initInNewContext() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var throttleHelper = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultsHelper = __webpack_require__(10);
	var methodExtendHelper = __webpack_require__(20);
