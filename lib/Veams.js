...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.VeamsCore = exports.Veams = undefined;
	 ...
	 * Variables
	 */
	var VeamsCore = __webpack_require__(4); /**
	                                         * Imports
	                                         */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultsHelper = __webpack_require__(5);
	var isTouchHelper = __webpack_require__(6);
	var mediaQueryHandler = __webpack_require__(7);
	...
	var Core = function () {
	    ...
	    */
				Veams.modules = new _modules2.default();
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = mediaQueryHandler;
	...
	var throttleHelper = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultsHelper = __webpack_require__(5);
	var methodExtendHelper = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaultsHelper = __webpack_require__(5);
	var queryHelper = __webpack_require__(15);
	var forEachHelper = __webpack_require__(17);
	var checkElInContextHelper = __webpack_require__(18);
	...
	var Modules = function () {
	   ...
	   */
			...
			value: function register(obj) {
				...
				forEachHelper(this.currentInstances, function (i, el) {
					...
					if (dataModules.indexOf(obj.domName) !== -1 && checkElInContextHelper(el, context)) {
						...
						var options = defaultsHelper(obj.options || {}, JSON.parse(attrs));
...
/***/ function(module, exports) {
	...
	exports.default = helpers.checkElementInContext;
	module.exports = exports['default'];
